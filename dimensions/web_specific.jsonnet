{
  ...
  br_features_pdf: {
    label: 'Is browser recognizes PDFs',
    column: 'br_features_pdf',
    category: 'Browser',
  },
  br_features_flash: {
    label: 'Is Flash installed',
    column: 'br_features_flash',
    category: 'Browser',
  },
  br_features_java: {
    label: 'Is Java installed',
    column: 'br_features_java',
    category: 'Browser',
  },
  br_features_director: {
    label: 'Is Adobe Shockwave installed',
    column: 'br_features_director',
    category: 'Browser',
  },
  br_features_quicktime: {
    label: 'Is QuickTime installed',
    column: 'br_features_quicktime',
    category: 'Browser',
  },
  br_features_realplayer: {
    label: 'Is RealPlayer installed',
  ...
  br_features_gears: {
    label: 'Is Google Gears installed',
    column: 'br_features_gears',
    category: 'Browser',
  },
  br_features_silverlight: {
    label: 'Is Silverlight installed',
    column: 'br_features_silverlight',
    category: 'Browser',
  },
  br_cookies: {
    label: 'Is cookies enabled',
    column: 'br_cookies',
    category: 'Browser',
  },
  br_colordepth: {
